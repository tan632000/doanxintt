                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            ...
                            <div class="product-action">
                                <a href="{{route('product_details',['id'=>$LatestProduct->id])}}"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-content text-center">
                            ...
                            <div class="cart-btn">
                                <form action="{{route('add_to_cart',['id'=>$LatestProduct->id])}}" method="POST" class="cart-and-action">
                                    @csrf
                                    <div class="">
                    ...
                    <div class="product-tab cat_product">
                        <ul class="nav" role="tablist">
                            ...
                            @foreach ($categories as $category)
                                <li class="nav-item  pb-5">
                                    <a class="nav-link" data-toggle="tab" href="#cate{{$category->id}}" role="tab">{{$category->category_name}}</a>
                                </li>
                            @endforeach
                        </ul>
                        <div class="tab-content">
                            <!--Tab start-->
                            <div class="tab-pane fade show active" id="allProducts" role="tabpanel" aria-labelledby="l1">
                                <!--owl-carousel start-->
                                    ...
                                    @foreach ($products as $product)
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                ...
                                                {{-- <a href="#"> <img class="secondary-img" src="{{asset('front-end/img/product-img/product1.jpg')}}"
                                                        alt=""></a> --}}
                                                <span>hot</span>
                                                <div class="product-action">
                                                    <a href="{{route('product_details',['id'=>$product->id])}}"><i class="far fa-eye"></i></a>
                                                    <a href="#"><i class="fas fa-balance-scale"></i></a>
                                                    <a href="#"><i class="fas fa-heart"></i></a>
                                                </div>
                                            </div>
                                            <div class="product-content text-center">
                                                ...
                                                <div class="cart-btn">
                                                    <form action="{{route('add_to_cart',['id'=>$product->id])}}" method="POST" class="cart-and-action">
                                                        @csrf
                                                        <div class="">
                                                            <div class="float-left">
                                                            {{-- <input type="number" name="product_quantity" class="form-control" value="1" min="1" required /> --}}
    ...
    <div class="banner-area pb-5">
        <div class="container">
            <div class="banner-img">
                <a href="#"><img class="img-fluid" src="{{asset('front-end')}}/img/banner-img/banner.jpg" alt=""></a>
            </div>
        </div>
    </div>
    <!--Product Area-->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="furniture1" role="tabpanel" aria-labelledby="l1">
                                <div class="product-active owl-carousel nav-style">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#"> <img src="{{asset('front-end/img/product-img/product1.jpg')}}" alt=""></a>
                                            <a href="#"> <img class="secondary-img" src="{{asset('front-end/img/product-img/product2.jpg')}}"
                                                    alt=""></a>
                                            <div class="product-action">
        ...
        <div class="container ">
            <div class="row">
                <div class="brand-active owl-carousel ">
                    <div class="single-brand"><a href=""><img src="{{asset('front-end/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('front-end/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('front-end/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('front-end/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
                    <div class="single-brand"><a href=""><img src="{{asset('front-end/img/brand/brand1.jpg')}}" alt="" class=""></a></div>
